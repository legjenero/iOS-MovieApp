...
class MovieDetailViewController: UIViewController {
    ...
    private func addConstraints(){
        ...
        genre.snp.makeConstraints{
            $0.leading.equalTo(view.snp.leading).offset(20)
            $0.bottom.equalTo(overview.snp.top).offset(-50)
        }
        ...
        overviewLabel.snp.makeConstraints {
            $0.leading.equalTo(view.snp.leading).offset(20)
            $0.top.equalTo(overview.snp.leading).offset(20)
        }
        movieDescription.snp.makeConstraints {
            $0.leading.equalTo(view.snp.leading).offset(20)
            $0.top.equalTo(overviewLabel.snp.leading).offset(10)
        }
        
        name1.snp.makeConstraints {
            $0.leading.equalTo(view.snp.leading).offset(20)
            $0.top.equalTo(movieDescription.snp.leading).offset(15)
        }
        job1.snp.makeConstraints {
            $0.leading.equalTo(view.snp.leading).offset(20)
            $0.top.equalTo(name1.snp.leading)
        }
        
        name2.snp.makeConstraints {
            $0.leading.equalTo(name1.snp.leading).offset(20)
            $0.top.equalTo(movieDescription.snp.leading).offset(15)
        }
        job2.snp.makeConstraints {
            $0.leading.equalTo(job1.snp.leading).offset(20)
            $0.top.equalTo(name2.snp.leading)
        }
        name3.snp.makeConstraints {
            $0.leading.equalTo(name2.snp.leading).offset(20)
            $0.top.equalTo(movieDescription.snp.leading).offset(15)
        }
        job3.snp.makeConstraints {
            $0.leading.equalTo(job2.snp.leading).offset(20)
            $0.top.equalTo(name3.snp.leading)
        }
        name4.snp.makeConstraints {
            $0.leading.equalTo(view.snp.leading).offset(20)
            $0.top.equalTo(job1.snp.leading).offset(15)
        }
        job4.snp.makeConstraints {
            $0.leading.equalTo(view.snp.leading).offset(20)
            $0.top.equalTo(name4.snp.leading)
        }
        
        name5.snp.makeConstraints {
            $0.leading.equalTo(name4.snp.leading).offset(20)
            $0.top.equalTo(name1.snp.leading).offset(15)
        }
        job5.snp.makeConstraints {
            $0.leading.equalTo(job5.snp.leading).offset(20)
            $0.top.equalTo(name5.snp.leading)
        }
